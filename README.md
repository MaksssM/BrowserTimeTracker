...
BrowserTimeTracker/
├── src/
│   ├── background.ts     # Фонова служба відстеження
│   ├── popup.ts          # Логіка popup інтерфейсу
│   └── translations.ts   # Мультимовні переклади
├── public/
│   ├── manifest.json     # Конфігурація розширення
│   ├── popup.html        # HTML інтерфейсу
│   └── style.css         # Стилі та теми
├── lib/
│   ├── chart.umd.min.js           # Chart.js бібліотека
...
_(Додайте скріншоти інтерфейсу)_
...
- [ ] Експорт у PDF з графіками
- [ ] Інтеграція з Google Calendar
- [ ] Система цілей та досягнень
- [ ] Email щотижневі звіти
- [ ] Фокус-режим з блокуванням сайтів
- [ ] AI-рекомендації по оптимізації часу
